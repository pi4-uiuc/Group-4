...
![](indoor_heights_by_cultivar.png){width = %60}
### Outdoor heights by cultivar:
![](outdoor_heights_by_cultivar.png){width = %60}
...
![](before_crop.png){width = %60}
![](cropped.png){width = %60}

![](../heightplot/ht_cultivar.png){width = %60}
![](../heightplot/ht_site.png){width = %60}

## Analysis

Growth rates for indoor-grown cultivars were 5.34, 5.82, 6.50, and 7.48.

![](../indoor_plots/lm_by_cultivar.png){width = %60}
...
![](../heightplot/growth-rates-site.png){width = %60}
